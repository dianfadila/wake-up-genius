...
<style>
  ...
  body {
    margin: 0; padding: 0; background: linear-gradient(135deg, #667eea, #764ba2);
...
<script>
  (function(){
    ...
    // Load saved alarm time and ringtone from localStorage
    ...
    // Clear any previous alarm timer
    function clearAlarm(){
